...
namespace He.Color {
  ...
  public CAM16Color cam16_from_int (int argb) {
    ViewingConditions vc = ViewingConditions.with_lstar(49.6);
    return xyz_to_cam16(rgb_to_xyz(from_argb_int(argb)), vc);
  }
  ...
  public HCTColor hct_blend (HCTColor a, HCTColor b) {
    var difference_degrees  = difference_degrees (a.h, b.h);
    var rot_deg = Math.fmin(difference_degrees * 0.5, 15.0);
    var output = sanitize_degrees (a.h + rot_deg * rotate_direction (a.h, b.h));
