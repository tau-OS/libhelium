...
public class He.StyleManager : Object {
  ...
  public void update () {
    ...
    var error_hct = is_dark ?
      Color.hct_blend (Color.from_params (20.0, 25.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (25.0, 75.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    ...
    var error_container_hct = is_dark ?
      Color.hct_blend (Color.from_params (25.0, 35.0, new ContrastCurve (contrast, 30, 30, 35, 40).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (20.0, 10.0, new ContrastCurve (contrast, 90, 90, 85, 70).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    ...
    var meson_red_hct = is_dark ?
      Color.hct_blend (Color.from_params (8.0, 85.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (2.0, 49.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    var meson_red_hex = Color.hct_to_hex (meson_red_hct.h, meson_red_hct.c, meson_red_hct.t);

    var lepton_orange_hct = is_dark ?
      Color.hct_blend (Color.from_params (55.0, 29.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (50.0, 61.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    ...
    var electron_yellow_hct = is_dark ?
      Color.hct_blend (Color.from_params (89.0, 37.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (81.0, 55.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    ...
    var muon_green_hct = is_dark ?
      Color.hct_blend (Color.from_params (152.0, 43.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (147.0, 71.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    var muon_green_hex = Color.hct_to_hex (muon_green_hct.h, muon_green_hct.c, muon_green_hct.t);

    var baryon_mint_hct = is_dark ?
      Color.hct_blend (Color.from_params (182.0, 25.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (177.0, 42.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    var baryon_mint_hex = Color.hct_to_hex (baryon_mint_hct.h, baryon_mint_hct.c, baryon_mint_hct.t);

    var proton_blue_hct = is_dark ?
      Color.hct_blend (Color.from_params (233.0, 34.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (240.0, 53.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    var proton_blue_hex = Color.hct_to_hex (proton_blue_hct.h, proton_blue_hct.c, proton_blue_hct.t);

    var photon_indigo_hct = is_dark ?
      Color.hct_blend (Color.from_params (291.0, 67.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (288.0, 84.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    ...
    var tau_purple_hct = is_dark ?
      Color.hct_blend (Color.from_params (309.0, 34.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (311.0, 57.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    var tau_purple_hex = Color.hct_to_hex (tau_purple_hct.h, tau_purple_hct.c, tau_purple_hct.t);

    var fermion_pink_hct = is_dark ?
      Color.hct_blend (Color.from_params (337.0, 34.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (340.0, 60.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
    ...
    var gluon_brown_hct = is_dark ?
      Color.hct_blend (Color.from_params (66.0, 12.0, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 80, 80, 85, 90).contrast_level)) :
      Color.hct_blend (Color.from_params (61.0, 30.0, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level), Color.from_params (cam16_color.h, cam16_color.c, new ContrastCurve (contrast, 40, 40, 35, 20).contrast_level));
