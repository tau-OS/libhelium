...
/**
* A SchemeFactory is a class which implements a method to generate a Scheme from an accent color and boolean representing whether the scheme is dark or light.
