...
public class He.MonochromaticScheme : SchemeFactory, Object {
    public Scheme generate (Color.CAM16Color accent, bool is_dark) {
        ...
        return Scheme () {
            ...
            // |\ | |___ |  |  |  |__/ |__| |
            // | \| |___ |__|  |  |  \ |  | |___
            surface_bg_hex = Color.hct_to_hex (hue, NEUTRAL, is_dark ? 4.0 : 100.0),
            surface_bg_variant_hex = Color.hct_to_hex (hue, NEUTRAL, is_dark ? 8.0 : 95.0),
            surface_fg_hex = Color.hct_to_hex (hue, NEUTRAL, is_dark ? 100.0 : 4.0),
            surface_fg_variant_hex = Color.hct_to_hex (hue, NEUTRAL, is_dark ? 95.0 : 8.0),
            inverse_surface_bg_hex = Color.hct_to_hex (hue, NEUTRAL, is_dark ? 90.0 : 20.0),
            inverse_surface_fg_hex = Color.hct_to_hex (hue, NEUTRAL, is_dark ? 20.0 : 90.0),
