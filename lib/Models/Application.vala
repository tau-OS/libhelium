  ...
  */
  ...
  private void update_accent_color() {
    ...
    var css = @"
      ...
      @define-color window_bg_color mix($base_background_hex, $accent_color_hex, 0.03);
      @define-color view_bg_color mix($card_background_hex, $accent_color_hex, 0.08);
      @define-color headerbar_bg_color shade(mix($base_background_hex, $accent_color_hex, 0.03), 0.96);
      @define-color popover_bg_color mix($base_background_hex, $accent_color_hex, 0.11);
      @define-color card_bg_color mix($card_background_hex, $accent_color_hex, 0.08);
