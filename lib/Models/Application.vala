...
public class He.Application : Gtk.Application {
  ...
  */
  ...
  private void update_accent_color() {
    ...
    var fg_contrast = Desktop.ColorScheme.DARK == desktop.prefers_color_scheme ? 15.2 : 13.6;
    var bg_contrast = Desktop.ColorScheme.DARK == desktop.prefers_color_scheme ? 2.0 : 2.2;
    ...
    var css = @"
      ...
      @define-color popover_bg_color mix($base_background_hex, $accent_color_hex, 0.12);
      @define-color card_bg_color mix($card_background_hex, $accent_color_hex, 0.09);
